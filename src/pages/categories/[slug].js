...
const CategoriesPage = () => {
  ...
  return (
    <acticle className="mt-12 flex flex-col text-dark dark:text-light">
      ...
      <div className="grid grid-cols-3 tablet:grid-cols-2 grid-rows-2 gap-16 mt-24 px-32 mobile:px-10 sm:px-5 ">
        {blogs.map((blog, index) => (
          <article key={index} className="col-span-1 mobile:col-span-3 tablet:col-span-1 sm:col-span-3 row-span-1 relative">
