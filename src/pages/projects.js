...
//   return (
//     <article className="w-full flex items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shawdow-2xl p-12 dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4 lg:w-4/5 md:w-2/3  ">
...
//   return (
//     <article className="w-full  lg:w-4/5 md:w-2/3 flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:boder-light h-[80%]">
...
const FeatureProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article className="w-full lg:w-full flex flex-col lg:flex-row items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 dark:bg-dark dark:border-light lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] bg-dark dark:bg-light rounded-br-3xl" />
...
const Project = ({ title, type, img, link, github }) => {
  return (
    <article className="w-full lg:w-1/2 flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light">
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem] bg-dark rounded-br-3xl dark:bg-light xs:p-4  md:-right-2 md:w-[101%] xs:h-[102%] xs:rounded-[1.5rem]" />
    ...
    <>
      ...
      <main className="w-full mb-16 p-20 flex flex-col items-center justify-center text-dark dark:text-light md:p-5">
        <Layout className="pt-12">
          ...
          <div className="grid grid-cols-12 xl:gap-24 gap-y-32 lg:gap-x-5 md:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeatureProject
                title=" Personal Web Application "
                img={logo}
