      ...
      <main className="flex w-full flex-col items-center justify-center">
        <Layout className="pt-16">
          <div className="grid w-full grid-cols-8 gap-16">
            <div className=" col-span-8  flex flex-col items-start justify-start  order-2   py-10 laptop:py-0 laptop:col-span-3 laptop:order-1">
            ...
            <div className="col-span-8 order-1 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light laptop:order-2 laptop:col-span-3  ">
            ...
            <div className="laptop:col-span-2 flex flex-col items-end justify-between dark:text-light tablet:!col-span-8 mobile:!col-span-8 sm:!col-span-8  tablet:flex-row laptop:items-center order-3 sm:flex-row py-10 laptop:py-0">
