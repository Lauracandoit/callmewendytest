          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center lg:pt-3 ">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs ">
                {" "}
                Thank you for checking in on my website. Nguyet is the place
                I share my personal projects, my passion with daily stuff and my
                personal experience day by day. Hope you are enjoy the time here
                and find something interesting and helpful. Do not hesitate to
                reach out in case you have any questions for me. I wish you a
                nice journey and wonderful day{" "}
              </p>
