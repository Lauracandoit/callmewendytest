  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full dark:text-light min-h-screen">
        <Layout className="pt-0 tablet:p-20  ">
          <div className="flex laptop:flex-row items-center justify-between w-full mobile:flex-col tablet:flex-col">
            <div className="w-1/2 tablet:w-full">
              <Image
                src={logo}
                className="w-full h-auto tablet:inline-block tablet:w-full mobile:w-full"
                priority
                sizes="(max-width: 768px) 100vw,
               (max-width:1200px) 50vw, 50vw"
              />
            </div>
            <div className="w-1/2 tablet:w-3/4 mobile:w-2/3 flex flex-col items-center self-center laptop:w-full laptop:text-center laptop:pt-3 tablet:pt-7 tablet:mx-10 mobile:pt-7  ">
              <h2 className="laptop:!text-8xl tablet:!text-4xl mobile:!text-xl font-extrabold ">
                <div className="mb-3 laptop:text-5xl"> Hi! I am</div>
              </h2>
              <div className="h-24 tablet:h-35 mobile:h-35 mobile:text-3xl tablet:text-5xl laptop:text-6xl ">
                <h2>
                  <TypeAnimation
                    sequence={[
