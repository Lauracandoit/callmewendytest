...
export const allBlogs = [buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobileCopy__indexMdx, automatingRepetitiveTasksProductivityHacksForDevelopersCopy__indexMdx, jsFrameworksComparisonCopy__indexMdx, blogOne__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, masteringCssGridLayout__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, progressiveWebAppsPwa__indexMdx, restfulApisBuildingBlocks__indexMdx, webAccessibilityBestPractices__indexMdx, webDevelopmentToolsProductivity__indexMdx]
